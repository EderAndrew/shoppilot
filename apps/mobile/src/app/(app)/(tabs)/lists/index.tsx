  ...
  return (
    <ScreenContainer scrollable>
      ...
      <SectionHeader
        ...
        action={
          <AppButton
            ...
            icon={<Plus size={18} />}
            size="sm"
            onPress={() => router.push("/(app)/(tabs)/lists/new" as Href)}
          >
            Nova
          </AppButton>
        }
      ...
      <AsyncState
        ...
        emptyMessage="Nenhuma lista ativa."
        error={lists.error}
        isEmpty={(lists.data?.length ?? 0) === 0}
        isLoading={lists.isLoading}
        onEmptyAction={() => router.push("/(app)/(tabs)/lists/new" as Href)}
